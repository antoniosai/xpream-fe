        ...
        <div class="content-body" style="padding-top:40px;">
            <ul class="tab-menu">
                <li v-if="
                        ...
                        " class="tab-link active" data-tab="jobcard">
                    Jobcard
                </li>
                <li v-if="
                            $bulkCan(
                ...
                <div class="card-header">
                    ...
                    <div class="option-box d-none test">
                        <div v-if="dfp_access" class="option-item">
                            <button :disabled="!dfp_access" v-on:click="
                        ...
                        <div class="option-item">
                            <select @change="filterscanneddfp()" v-model="multiselectfilteroption" style="width:100px;">
                                <option :disabled="!dfp_url.length > 0" style="white-space: nowrap" value="">Filter DFP
                                </option>
                                <option :disabled="!dfp_url.length > 0" style="white-space: nowrap" value="scan">
                                    <b>available scanned files</b></option>
                                <option :disabled="!dfp_url.length > 0" style="white-space: nowrap" value="unscan">
                                    <b>unavailable scanned files</b></option>
                            </select>
                            <multiselect :close-on-select="false" v-model="datatable.serverParams.filter.order"
                                tag-placeholder="Add this as new tag" placeholder="Multiple Select Order No"
                                :options="options_order" :multiple="true" :taggable="true" label="AUFNR" track-by="AUFNR"
                                @tag="addTag" @open="initfilterOrder" :limit="6"
                                style="min-width: 250px; max-width: 400px; padding-left: 5px; max-height:350px;">
                            </multiselect>
                            <button class="button is-secondary is-default" style="width:15px;font-size:11px;"
                                v-on:click="clearfilterorder()">
                                <i class="material-icons" style="margin:0px;">close</i></button>&nbsp;&nbsp;
                        ...
                        <div class="option-item">
                            <h4>
                                {{ projectinfo }}&nbsp;&nbsp;&nbsp;<button class="button is-secondary is-success"
                    ...
                    <div class="option-box">
                        <div class="option-item">
                            <multiselect :close-on-select="false" v-model="datatable.serverParams.filter.AC_REG"
                                tag-placeholder="Add this as new tag" placeholder="Multiple Select AC Reg" :options="acRegs"
                                :multiple="true" :taggable="true" label="ac_reg" track-by="ac_reg"
                                style="min-width: 250px; max-width: 400px; padding-left: 5px; max-height:350px;">
                            </multiselect>
                            <button class="button is-secondary is-default" style="width:15px;font-size:11px;"
                                ...
                                <div v-show="renderedFields">
                                    <vue-good-table max-height="90vh" :fixed-header="true" ref="table-job-tracking"
                                        ...
                                        :search-options="{
                                            ...
                                            }" :line-numbers="true" @on-search="onColumnSearch"
                                        ...
                                        @on-selected-rows-change="
                                                selectionChanged
                                            " @on-select-all="selectAll" @on-row-click="toggleSelectRow"
                                        :totalRows="datatable.totalRows" :pagination-options="{
                                                enabled: true,
                                                mode: 'pages',
                                                perPage:
                                        ...
                                        <div slot="table-actions">
                                            <div class="toolbar toolbar-default">
                                                <div class="toolbar-item toolbar-dropdown"></div>
                                                <div class="toolbar-item d-none test" style="margin-right: -8px;">
                                                    <div v-on:click="
                                                                handlerExportJob()
                                                            "
                                                ...
                                                <div class="toolbar-item d-none test" style="margin-right: -10px;">
                                                    <button :disabled="
                                                                !grant_access
                                                            " v-on:click="
                                                ...
                                                <div class="toolbar-item" style="margin-right: -10px;">
                                                    <button :disabled="
                                                                datatable.rows < 1
                                                            " id="btn-collapse-all" v-on:click="
                                                                handlerToggleAll(
                                                                    'material-list',
                                                                    'btn-collapse-all',
                                                                    'icon-collapse-all',
                                                            ...
                                                            " class="button is-default">
                                                        <i id="icon-collapse-all" class="material-icons">visibility</i>
                                                        Material
                                                    </button>
                                                </div>
                                                <div class="toolbar-item" style="margin-right: -10px;">
                                                ...
                                                <div class="toolbar-item tooltip-x d-none test"
                                        ...
                                        <template slot="table-row" slot-scope="props">
                                                ...
                                                <span v-if="
                                                    ...
                                                    <button :id="
                                                                'btn-material-list-' +
                                                                    props.index
                                                            " statetoggle="0"
                                                        class="button is-secondary is-success btn-material-list" v-on:click="
                                                                handlerToggle(
                                                                    'btn-material-list-' +
                                                                        props.index,
                                                                    'icon-material-list-' +
                                                ...
                                                <span v-else-if="
                                                    ...
                                                    <button :id="
                                                                'btn-material-list-' +
                                                                    props.index
                                                            " statetoggle="0"
                                                        class="button is-secondary is-danger btn-material-list" v-on:click="
                                                                handlerToggle(
                                                                    'btn-material-list-' +
                                                                        props.index,
                                                                    'icon-material-list-' +
                                                ...
                                                <div class="is-row" style="margin-bottom: 0px;">
                                                    ...
                                                    <div class="is-col is-10">
                                                        <i v-on:click="
                                                            ...
                                                            style="font-size: 16pt;line-height: 0; padding-top:10px; cursor:pointer;">chat</i>
                                                    </div>
                                                </div>
                                            </span>
                                            <span v-else-if="
                                                        props.column.field ==
                                                            'SEQ_SWIFT'
                                                    ">
                                                <input v-if="isPKG" :disabled="!grant_access" :value="
                                                            props.formattedRow[
                                                                props.column.field
                                                            ]
                                                        " :id="
                                            ...
                                            <span v-else-if="
                                                        props.column.field ==
                                                            'DATE_DONE'
                                                    ">
                                                <input :disabled="!grant_access" :value="
                                                            props.formattedRow[
                                                                props.column.field
                                                            ]
                                                        " :id="
                                            ...
                                            <span v-else-if="
                                                ...
                                                <select v-model="
                                                    ...
                                                    <option v-for="phase in phases" :key="phase.PHASE_CODE" :datacode="
                                                                phase.PHASE_CODE
                                                            " :value="
                                                                phase.PHASE_NAME
                                                            ">{{
                                            ...
                                            <span v-else-if="
                                                ...
                                                <select v-model="
                                                        ...
                                                        ">
                                                    <option value="">Set Default</option>
                                                    <option v-for="zonearea in zoneareas" :key="
                                                                zonearea.AREA_CODE
                                                            " :datacode="
                                                                zonearea.AREA_CODE
                                                            " :value="
                                            ...
                                            <span v-else-if="
                                                        props.column.field ==
                                                            'STATUS'
                                                    ">
                                                <div style="margin-top: 6px; text-align: center; cursor: pointer;"
                                                    v-on:click="
                                                        ...
                                                        ">
                                                    <span class="status-handler success" v-if="
                                                                props.formattedRow[
                                                                    props.column
                                                                        .field
                                                                ] === 'DONE'
                                                    ...
                                                    <span class="status-handler warning" v-else-if="
                                                                props.formattedRow[
                                                                    props.column
                                                                        .field
                                                                ] === 'PROGRESS'
                                                    ...
                                                    <span class="status-handler primary" v-else-if="
                                                                props.formattedRow[
                                                                    props.column
                                                                        .field
                                                                ] === 'OPEN'
                                                    ...
                                                    <span class="status-handler danger" v-else>{{
                                                                props.formattedRow[
                                                                    props.column
                                                                        .field
                                                                ]
                                            ...
                                            <span v-else-if="
                                                    ...
                                                    ">
                                                <div style="margin-top: 6px; text-align: center;">
                                                    <span class="status-handler danger" v-if="
                                                                props.formattedRow[
                                                                    props.column
                                                                        .field
                                                                ] === 'FINDING'
                                            ...
                                            <span v-else-if="
                                                ...
                                                <div style="margin-top: 6px; text-align: center;">
                                                    <span class="status-handler success" v-if="
                                                            ...
                                                            "><i class="material-icons"
                                                            style="font-size: 8pt;line-height: 0;">done</i></span>
                                                    <span v-else-if="
                                                                props.formattedRow[
                                                                    props.column
                                                                        .field
                                                        ...
                                                        <i class="material-icons"
                                                            style="font-size: 8pt;line-height: 0;">close</i></span>
                                                    <span v-else-if="
                                                                props.formattedRow[
                                                                    props.column
                                                                        .field
                                                            ...
                                                            " class="status-handler default"><i class="material-icons"
                                                            style="font-size: 8pt;line-height: 0;">close</i></span>
                                                </div>
                                            </span>
                                            <span v-else-if="
                                                ...
                                                <div style="margin-top: 6px; text-align: center;">
                                                    ...
                                                    <span v-else-if="
                                                            ...
                                                            " class="status-handler danger"><i class="material-icons"
                                                            style="font-size: 8pt;line-height: 0;">close</i></span>
                                                    <span v-else-if="
                                                                props.formattedRow[
                                                                    props.column
                                            ...
                                            <span v-else-if="
                                                ...
                                                <span v-if="cust_access == true">
                                                    <input :disabled="!cust_access" :value="
                                                                props.formattedRow[
                                                                    props.column
                                                                        .field
                                                                ]
                                        ...
                                        <div slot="selected-row-actions" id="selected-row-actions">
                                            <div class="d-none test">
                                                ...
                                                <v-select label="label" :options="optionsDay" v-model="daysAll"
                                                    @input="onChangeDaysAll" style=""></v-select>
                                            ...
                                            <select v-model="track_status" :disabled="
                                                        !grant_access ||
                                                            datatable.selectedRows
                                                                .length < 1
                                                    ">
                                                <option value="">Update Jobcard
                                                    Status</option>
                                                <option v-for="track in tracks" :key="track.ID" :value="track.ID">{{
                                                            track.TRACK_NAME
                                                        }}</option>
                                            ...
                                            <button v-on:click="
                                                        handleUpdateStatus()
                                                    " class="button is-default" type="button" id="update-status" :disabled="
                                                        !grant_access ||
                                                            datatable.selectedRows
                                                                .length < 1
                                                    ">
                                            ...
                                            <select v-model="update_positions" :disabled="
                                                        !grant_access ||
                                                            datatable.selectedRows
                                                                .length < 1
                                                    ">
                                                <option value="">Update Positions</option>
                                                <option :disabled="
                                                            position.is_show == 2
                                                                ? true
                                                                : false
                                            ...
                                            <button v-on:click="
                                                    ...
                                                    " class="button is-default" type="button" id="update-position"
                                                :disabled="
                                                        !grant_access ||
                                                            datatable.selectedRows
                                                                .length < 1
                                            ...
                                            <select v-if="dfp_access" v-model="update_dfp" :disabled="
                                                        !dfp_access ||
                                                            datatable.selectedRows
                                                                .length < 1
                                                    ">
                                                <option value="">Update DFP</option>
                                                <option v-for="dfpstat in dfpstats" :key="dfpstat" :value="dfpstat">
                                                    {{ dfpstat }}</option>
                                            </select>
                                            <input v-if="
                                                        update_dfp != '' &&
                                                            dfp_access
                                                    " v-model="dfpremark" :disabled="
                                                        !dfp_access ||
                                                            datatable.selectedRows
                                                                .length < 1
                                                    " placeholder="remarks" />
                                            <button v-if="dfp_access" v-on:click="handleUpdateDFP()"
                                                class="button is-default" type="button" id="update-dfp" :disabled="
                                                        !dfp_access ||
                                                            datatable.selectedRows
                                                                .length < 1
                                                    ">
                                            ...
                                            <span v-if="
                                                ...
                                                <multiselect :close-on-select="false" v-model="findingcateg"
                                                    tag-placeholder="" placeholder="Type and enter"
                                                    :options="options_finding" :multiple="true" :taggable="true"
                                                    @tag="addTagf" style="width:100%;">
                                                </multiselect>
                                            </span>
                                        </div>
                                    </vue-good-table>
                ...
                <div class="modal sm">
                    ...
                    <div class="modal-body" style="position: relative">
                        ...
                        <div class="is-row">
                            ...
                            <div class="form-item is-col is-100">
                                <button class="button is-secondary is-success" v-on:click="handlerExportforupdate()">
                                    Download Template
                                </button>
                            </div>
                        </div>
            ...
            <div class="modal-box" id="modal-task-review" data-keyboard="false" data-backdrop="static">
                <div class="modal sm">
                    ...
                    <div class="modal-body" style="position: relative; font-size:12px;" v-if="trb.order_index !== null">
                        <div class="form-item">
                            <div class="is-row" style="margin-bottom: 5px;">
                                <div class="is-col is-10">
                                    <label>Order No</label>
                                </div>
                                <div class="is-col is-40" style="border-radius: 5px;border: 1px solid grey;padding:5px;">
                                    {{ trb.form.orderno }}
                                </div>
                                <div class="is-col is-10">
                        ...
                        <div class="form-item">
                            <div class="is-row" style="margin-bottom: 5px;">
                                ...
                                <div v-show="
                                    ...
                                    <table>
                                        <tr v-for="(mat, index) in datatable
                                                    .rows[trb.order_index].MATERIAL" :key="index">
                                            <td>
                                                {{ mat.split("] ")[0] + "]" }}
                                            </td>
                                        </tr>
                            ...
                            <div class="is-row" style="margin-bottom: 5px;">
                                ...
                                <div class="is-col is-30">
                                    <select v-model="trb.form.feedbacktype">
                                        <option v-for="(categ, index) in trb.master
                                                    .categ" :key="index" :value="categ.ID">{{ categ.NAME }}</option>
                                    </select>
                                </div>
                                <div class="is-col is-10">
                                    <label>Urgency</label>
                                ...
                                <div class="is-40">
                                    <div class="is-row">
                                        <div class="is-col is-70">
                                            <input id="prior-feedback" v-on:change="changePriorCapt()"
                                                style="margin-top: -6px;" type="range" min="1" max="3" step="1" v-model="
                                                        trb.form.priority.value
                                                    " />
                                        </div>
                                        <div class="is-col is-30">
                                            <span id="prior-caption" :style="
                                                        'color :' +
                        ...
                        <div class="form-item">
                            <textarea placeholder="Insert your comment or feedback here" rows="5"
                                v-model="trb.form.comment"></textarea>
                        </div>
                    </div>
                    <div class="modal-footer" style="">
                        <button class="button is-primary is-default cancel" v-on:click="hideModal('modal-task-review')">
                            Cancel
                        </button>
                        <button v-on:click="addFeedback()" type="button" class="button" id="btn-save-feedback">
                            Submit
                        </button>
                    </div>
                    <!-- </form> -->
            ...
            <!--modal print slip-->
            <div class="modal-box" id="modal-print-slip" data-keyboard="false" data-backdrop="static">
                <div class="modal" style="width:90%;">
                    <span class="close" v-on:click="hideModal('modal-print-slip')"></span>
                    <div class="modal-header">
                        <h2 class="title">Goods Issue Slip</h2>
                    </div>
                    <div v-for="(dataplansliporder,
                            index) in dataplanslip.material" :key="index" :id="'printthisslip' + index" class="modal-body"
                        ...
                        <table>
                            ...
                            <tbody>
                                <tr v-for="(slip,
                                        index2) in dataplansliporder.MRM" :key="index2">
                                    <td>{{ slip.MATNR }}</td>
                                    ...
                                    <td>{{ slip.MEINS }}</td>
                                    <td>
                                        <input style="border: none;border-bottom: 2px solid grey;" placeholder="" v-model="
                                    ...
                                    <!--td
                                        ...
                                        -->
                                    <td>
                                        <input style="border: none; border-bottom: 2px solid grey;"
                                    ...
                                    <!--td
                                        ...
                                        -->
                                    <td>
                                        <input type="date" style="border: none; border-bottom: 2px solid grey;" v-model="
                        ...
                        <div width="100%" style="text-align:right;">
                            <VueBarcode :value="dataplansliporder.AUFNR" height="50" textPosition="top"
                    ...
                    <div class="modal-footer" style="">
                        *the data that you change/update in the underlined field
                        ...
                        <button v-on:click="slip_printout" class="button is-success">
                            Print
                        </button>
                        <button class="button is-primary is-default cancel" v-on:click="hideModal('modal-print-slip')">
                            Close
                        </button>
                    </div>
                    <!-- </form> -->
            ...
            <div class="modal-box" data-keyboard="false" data-backdrop="static">
                <div id="outputprintslip" class="modal-body" style="position: relative; font-size: 9px;">
                    <div v-for="(dataplansliporder,
                            index) in dataplanslip.material" :key="index" :id="'printthisslip' + index"
                        class="modal-body detectpagebreak" style="position: relative">
                        <table width="100%">
                            <tr>
                                <td width="30%">
                        ...
                        <table class="materialitem" style="border-collapse: collapse;" width="100%">
                            <thead>
                                <th>Material</th>
                                <!--th>Alternate</th-->
                                <th>Description</th>
                            ...
                            <tbody>
                                <tr v-for="(slip,
                                    ...
                                    <td>{{ slip.MEINS }}</td>
                                    <td>
                                        <span style="border: none; border-bottom: 2px solid grey;">{{
                                                    dataplanslip.batch[slip.ID]
                                                }}</span>
                                    </td>
                                    <td>
            ...
            <div class="modal-box" id="modal-timeline" data-keyboard="false" data-backdrop="static">
                <div class="modal sm">
                    ...
                    <div class="modal-footer" style="">
                        <button class="button is-primary is-default cancel" v-on:click="hideModal('modal-timeline')">
                            Close
                        </button>
                    </div>
                </div>
            ...
            <!-- modal dfplink -->
            <div class="modal-box" id="modal-dfplink" data-keyboard="false" data-backdrop="static">
                <div class="modal lg">
                    <span class="close" v-on:click="hideModal('modal-dfplink')"></span>
                    <div class="modal-header">
                        <h2 class="title">
                    ...
                    <div class="modal-body" style="position: relative">
                        ...
                        <div class="is-row">
                            <div class="is-col is-80">
                                <input :value="dfpfolder" id="inputdfpfolder" v-on:keyup.enter="
                    ...
                    <div class="modal-footer" style="">
                        <button class="button is-primary is-default cancel" v-on:click="hideModal('modal-dfplink')">
                            Close
                        </button>
                    </div>
                    <!-- </form> -->
            ...
            <div class="modal-box" id="modal-layout" data-keyboard="false" data-backdrop="static">
                <div class="modal sm">
                    ...
                    <div class="modal-body" style="position: relative; height:500px; overflow-y:auto;">
                        <draggable :list="datatable.fields" class="list-group" ghost-class="ghost" v-bind="dragOptions"
                            @start="drag = true" @end="drag = false" @change="handlerDateDoneJC">
                                ...
                                <div v-for="(element, index) in datatable.fields" :key="index + 0">
                                    <div v-if="element.isShow" class="list-group-item">
                                        ...
                                        <div class="is-row" v-if="!element.hidden" style="font-weight:bold;">
                                            ...
                                            <div class="is-col is-10">
                                                <button class="button is-100 is-secondary is-success"
                                                    style="padding:0px !important;" v-on:click="
                                                            element.hidden = true
                                                        ">
                                                    HIDE
                                                </button>
                                        ...
                                        <div class="is-row" v-else>
                                            ...
                                            <div class="is-col is-10">
                                                <button class="button is-100 is-default" v-on:click="
                    ...
                    <div class="modal-footer" style="">
                        <button class="button is-primary is-default cancel" v-on:click="hideModal('modal-layout')">
                            Close
                        </button>
            ...
            <!-- modal list backup -->
            <div class="modal-box" id="modal-download-backup" data-keyboard="false" data-backdrop="static">
                <div class="modal sm">
                    <span class="close" v-on:click="hideModal('modal-download-backup')"></span>
                    <div class="modal-header">
                    ...
                    <div class="modal-body" style="position: relative">
                        ...
                        <hr />
                        <span v-for="(listdownload, index) in listdatabackup" :key="index">
                            <button class="button is-success" v-on:click="
                    ...
                    <div class="modal-footer" style="">
                        <button class="button is-primary is-default cancel" v-on:click="hideModal('modal-download-backup')">
                            Close
                        </button>
                    </div>
                    <!-- </form> -->
            ...
            <div class="modal-box" id="modal-single-add" data-keyboard="false" data-backdrop="static">
                <div class="modal lg">
                    ...
                    <div class="modal-body" style="position: relative">
                        ...
                        <div class="is-row">
                            ...
                            <div class="form-item is-col is-10">
                                <input v-model="form.seq" value="" type="text" />
                            ...
                            <div class="form-item is-col is-50">
                                <input v-model="form.description" value="" type="text" />
                        ...
                        <div class="is-row" style="margin-top: -10px;">
                            ...
                            <div class="form-item is-col is-10">
                                <select v-model="form.jc_track">
                                    <option value="">Option</option>
                                    <option v-for="track in tracks" :key="track.ID" :value="track.ID">{{ track.TRACK_NAME }}
                                    </option>
                                </select>
                            ...
                            <div class="form-item is-col is-25">
                                <select v-model="form.review_position">
                                    ...
                                    <option :disabled="
                                            ...
                                            " v-for="position in positions" :key="position.ID" :value="position.ID">
                    ...
                    <div class="modal-footer" style="">
                        <button class="button is-primary is-default cancel" v-on:click="hideModal('modal-single-add')">
                            Close
                        </button>
                        <button v-on:click="handlerSaveSinglJc()" class="button is-success" type="submit"
                            id="btn-single-add">
                            Save
                        </button>
                    </div>
