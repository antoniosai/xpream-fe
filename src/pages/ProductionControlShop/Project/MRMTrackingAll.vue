                ...
                <div class="card-header">
                    ...
                    <div class="option-box">
                        <div class="option-item">
                            ...
                            <multiselect :close-on-select="false" v-model="datatable.serverParams.filter.order"
                                tag-placeholder="Add this as new tag" placeholder="Type and enter"
                                :options="options_order" :multiple="true" :taggable="true" label="AUFNR"
                                track-by="AUFNR" @tag="addTag" @open="initfilterOrder"
                        ...
                        <div class="option-item">
                            <multiselect :close-on-select="false" v-model="datatable.serverParams.filter.AC_REG"
                                tag-placeholder="Add this as new tag" placeholder="Multiple Select AC Reg"
                                :options="acRegs" :multiple="true" :taggable="true" label="ac_reg" track-by="ac_reg"
...
<h4>{{projectinfo}}&nbsp;&nbsp;&nbsp;<button class="button is-secondary is-success " style="padding:0px 15px;height:30px;">{{acreginfo}}</button></h4>
                ...
                <div class="card-content">
                    <div style="box-sizing: border-box; position: relative; min-height: 20px;">
                        <div>
                            <loading style="margin-top: 50px;" :active.sync="loading.isLoading" :can-cancel="false"
                                :is-full-page="false" :color="loading.color" :loader="loading.loaderType">
                            </loading>
                            <template>
                                <div v-show="renderedFields">
                                    <vue-good-table max-height="90vh" :fixed-header="true" ref="table-job-tracking"
                                        :columns="datatable.fields" :rows="datatable.rows"
                                        :row-style-class="rowStyleClassFn" styleClass="vgt-table bordered" mode="remote"
                                        :search-options="{
                                enabled: true,
                                trigger: 'keyup',
                                skipDiacritics: true,
                                ...
                                }" :line-numbers="true" @on-search="onColumnSearch" @on-page-change="onPageChange"
                                        @on-sort-change="onSortChange" @on-column-filter="onColumnFilter"
                                        @on-per-page-change="onPerPageChange"
                                        @on-selected-rows-change="selectionChanged" :totalRows="datatable.totalRows"
                                        :pagination-options="{
                                enabled: true,
                                mode: 'pages',
                                            ...
                                            <div class="toolbar toolbar-default">
                                                <template v-if="false">
                                                    <div class="toolbar-item" style="margin-right: -8px;">
                                                        <div v-on:click="handlerExportMRM()"
                                                            ...
                                                            <i
                                                                class="material-icons warning sync_order">file_download</i>
                                                        </div>
                                                    </div>
                                                    <div class="toolbar-item" style="margin-right: -8px;">
                                                        <select v-on:change="handlerFilterVisibility()"
                                                            v-model="datatable.serverParams.filter.visibility">
                                                            <option value="All">All Material</option>
                                                            <option value="y">Default List</option>
                                                            <option value="n">Excluded List</option>
                                                        </select>
                                                    </div>
                                                    <div v-if="!is_cust" class="toolbar-item"
...
Inventory
                                                    ...
                                                    <div class="toolbar-item" style="margin-right: -8px;">
                                                        <button :disabled="!grant_access"
                                                            v-on:click="(grant_access) ? handlerModalSingleAdd() : ''"
                                                    ...
                                                    <div class="toolbar-item" style="margin-right: -8px;">
                                                        <button :disabled="!grant_access"
                                                            v-on:click="(grant_access) ? handlerModalBulkAdd() : ''"
                                                            class="button is-default">
                                                            <i class='material-icons'>
                                                                add_circle
                                                            </i>
                                                    ...
                                                    <div class="toolbar-item" style="margin-right: -10px;">
                                                        <button :disabled="!grant_access"
                                                            v-on:click="(grant_access) ? handlerModalImport() : ''"
                                                            class="button is-default">
                                                            <i class='material-icons'>
                                                                insert_drive_file
                                                            </i>
                                                    ...
                                                    <div class="toolbar-item tooltip-x" style="margin-right: -10px;">
                                                        <button :disabled="!checklastsync"
                                                            v-on:click="(checklastsync) ? handlerSyncData() : ''"
                                        ...
                                        <template slot="table-row" slot-scope="props">
                                            <span class="ctoggle" v-if="props.column.field == 'VISIBILITY'">
                                                <div>
                                                    <input :disabled="!grant_access" type="checkbox"
                                                        class="switch unset" @change="changeVisibility(props.row)"
                                                        true-value="y" false-value="n" v-model="props.row.VISIBILITY">
                                                </div>
                                            </span>
                                            ...
                                            ">
                                                    <input :disabled="!grant_access" type="checkbox"
                                                        :class="'switchprio unset'" @change="changePriority(props.row)"
                                                        true-value="0" false-value="" v-model="props.row.URGENCY">
                                            ...
                                            <span v-else-if="props.column.field == 'ALTERNATEPN'">
                                                <input :disabled="!grant_access"
                                                    :value="props.formattedRow[props.column.field]"
                                                    :id="'mrm-track-alternatepn-' +props.index"
                                                    v-on:change="handlerUpdateData(props.formattedRow['ID'], 'ALTERNATEPN', 'mrm-track-alternatepn-' +props.index)">
                                            </span>
                                            ...
                                            <span v-else-if="props.column.field == 'BATCH'">
                                                <input :disabled="!grant_access"
                                                    :value="props.formattedRow[props.column.field]"
                                                    :id="'mrm-track-batch-' +props.index"
                                                    v-on:change="handlerUpdateData(props.formattedRow['ID'], 'BATCH', 'mrm-track-batch-' +props.index)"
                                                    type="text">
                                            </span>
                                            <span v-else-if="props.column.field == 'ATTACHMENT'">
                                                <span v-if="props.formattedRow[props.column.field]">
                                                    ...
                                                    <button
                                                        v-on:click="handlerOpenLink(props.formattedRow[props.column.field])"
                                                        style="height: 27px;" class="button is-default">
                                                        <i class='material-icons'>
                                                            insert_link
                                                        </i>
                                                    </button>
                                            ...
                                            <span v-else-if="props.column.field == 'BDMNG'">
                                                ...
                                                <span
                                                    v-else>{{parseFloat(props.formattedRow[props.column.field]).toFixed(2)}}</span>
                                            </span>
                                            ...
                                            <span v-else-if="props.column.field == 'INACT'">
                                                <div style="margin-top: 6px; text-align: center;">
                                                    <span class="status-handler warning"
                                                        v-if="props.formattedRow[props.column.field] > 0">X</span>
                                                    <span v-else>-</span>
                                                </div>
                                            </span>
                                            ...
                                            <span v-else-if="props.column.field == 'ORDER_STATUS'">
                                                <div style="margin-top: 6px; text-align: center;">
                                                    <span class="status-handler success"
                                                        v-if="props.formattedRow[props.column.field] === 'DONE'">{{props.formattedRow[props.column.field]}}</span>
                                                    <span class="status-handler warning"
                                                        v-else-if="props.formattedRow[props.column.field] === 'PROGRESS'">{{props.formattedRow[props.column.field]}}</span>
                                                    <span class="status-handler primary"
                                                        v-else-if="props.formattedRow[props.column.field] === 'OPEN'">{{props.formattedRow[props.column.field]}}</span>
                                                    <span
                                                        v-else-if="props.formattedRow[props.column.field] === null || props.formattedRow[props.column.field] === ''">{{props.formattedRow[props.column.field]}}</span>
                                                    <span class="status-handler danger"
                                                        v-else>{{props.formattedRow[props.column.field]}}</span>
                                                </div>
                                            </span>
                                            <span v-else-if="props.column.field == 'MATFULSTAT'">
                                                <div style="margin-top: 6px; text-align: center;">
                                                    <span
                                                        v-if="props.formattedRow['QTYOWING'] !='0.0' && 
                                                    (props.formattedRow['QTYDEL'] !='0.0' || props.formattedRow['QTYINS'] !='0.0') &&
                                                    (props.formattedRow['QTYDEL'] !=null || props.formattedRow['QTYINS'] !=null)">
                                                        <i class='material-icons'
                                                            style="font-size:14px; color:#2ECC71;">donut_small</i>
                                                    </span>

                                                    <span style="background-color: #2ECC71;" class="status-handler"
                                                        v-if="props.formattedRow[props.column.field] === 'Delivered to Production'">
                                                        <span
                                                            v-on:click="handlerModalTimeline(props.formattedRow['ID'])"
                                                            style="cursor: pointer;">
                                                            {{props.formattedRow[props.column.field]}}
                                                        </span>
                                                    </span>
                                                    <span style="background-color: #2ECC71;" class="status-handler"
                                                        v-else-if="props.formattedRow[props.column.field] === 'Work Done'">
                                                        <span
                                                            v-on:click="handlerModalTimeline(props.formattedRow['ID'])"
                                                            style="cursor: pointer;">
                                                            {{props.formattedRow[props.column.field]}}
                                                    ...
                                                    <span style="background-color: #3498DB;" class="status-handler"
                                                        v-else-if="props.formattedRow[props.column.field] === 'Available at Hangar Local Store'">
                                                        <span
                                                            v-on:click="handlerModalTimeline(props.formattedRow['ID'])"
                                                            style="cursor: pointer;">
                                                            {{props.formattedRow[props.column.field]}}
                                                    ...
                                                    <span
                                                        v-else-if="props.formattedRow[props.column.field] === 'Waiting for Distribution'">
                                                        <span
                                                            v-on:click="handlerModalTimeline(props.formattedRow['ID'])"
                                                            style="background-color: #3498DB; cursor: pointer;"
                                                            class="status-handler">
                                                            {{props.formattedRow[props.column.field]}}
                                                        </span>&nbsp;
                                                        <span style="cursor: pointer; background-color: #D2D2D2;"
                                                            class="status-handler"
                                                            v-if="props.formattedRow['GADCREQ']=='y'"
                                                            v-on:click="viewgadcstatusdetail(props.formattedRow['ID'])">
                                                            <i class='material-icons'
                                                                style="font-size:14px;">error_outline</i>
                                                        </span>
                                                    </span>
                                                    <span style="background-color: #F39C12;" class="status-handler"
                                                        v-else-if="props.formattedRow[props.column.field] === 'Shortage'">
                                                        <span
                                                            v-on:click="handlerModalTimeline(props.formattedRow['ID'])"
                                                            style="cursor: pointer;">
                                                            {{props.formattedRow[props.column.field]}}
                                                    ...
                                                    <span style="background-color: #E74C3C;" class="status-handler"
                                                        v-else-if="props.formattedRow[props.column.field] === 'No Source'">
                                                        <span
                                                            v-on:click="handlerModalTimeline(props.formattedRow['ID'])"
                                                            style="cursor: pointer;">
                                                            {{props.formattedRow[props.column.field]}}
                                                    ...
                                                    <span style="background-color: #E74C3C;" class="status-handler"
                                                        v-else-if="props.formattedRow[props.column.field] === 'Waiting Payment'">
                                                        <span
                                                            v-on:click="handlerModalTimeline(props.formattedRow['ID'])"
                                                            style="cursor: pointer;">
                                                            {{props.formattedRow[props.column.field]}}
                                                    ...
                                                    <span style="background-color: #E74C3C;" class="status-handler"
                                                        v-else-if="props.formattedRow[props.column.field] === 'Waiting Purchase Order'">
                                                        <span
                                                            v-on:click="handlerModalTimeline(props.formattedRow['ID'])"
                                                            style="cursor: pointer;">
                                                            {{props.formattedRow[props.column.field]}}
                                                    ...
                                                    <span style="background-color: #8E44AD;" class="status-handler"
                                                        v-else-if="props.formattedRow[props.column.field] === 'Waiting Customer Approval'">
                                                        <span
                                                            v-on:click="handlerModalTimeline(props.formattedRow['ID'])"
                                                            style="cursor: pointer;">
                                                            {{props.formattedRow[props.column.field]}}
                                                    ...
                                                    <span style="background-color: #138D75;" class="status-handler"
                                                        v-else-if="props.formattedRow[props.column.field] === 'Waiting Send to Shop'">
                                                        <span
                                                            v-on:click="handlerModalTimeline(props.formattedRow['ID'])"
                                                            style="cursor: pointer;">
                                                            {{props.formattedRow[props.column.field]}}
                                                    ...
                                                    <span style="background-color: #138D75;" class="status-handler"
                                                        v-else-if="props.formattedRow[props.column.field] === 'Progress Repair in Shop'">
                                                        <span
                                                            v-on:click="handlerModalTimeline(props.formattedRow['ID'])"
                                                            style="cursor: pointer;">
                                                            {{props.formattedRow[props.column.field]}}
                                                    ...
                                                    <span style="background-color: #7B241C;" class="status-handler"
                                                        v-else-if="props.formattedRow[props.column.field] === 'Finding at Receiving Area'">
                                                        <span
                                                            v-on:click="handlerModalTimeline(props.formattedRow['ID'])"
                                                            style="cursor: pointer;">
                                                            {{props.formattedRow[props.column.field]}}
                                                    ...
                                                    <span
                                                        v-else-if="props.formattedRow[props.column.field] === 'Available at GMF Central Store'">
                                                        <span
                                                            v-on:click="handlerModalTimeline(props.formattedRow['ID'])"
                                                            style="background-color: #7B241C; cursor: pointer;"
                                                            class="status-handler">
                                                            {{props.formattedRow[props.column.field]}}
                                                        </span>&nbsp;
                                                        <span style="cursor: pointer; background-color: #D2D2D2;"
                                                    ...
                                                    <span style="background-color: #B7950B;" class="status-handler"
                                                        v-else-if="props.formattedRow[props.column.field] === 'Progress Inspect in Receiving Area'">
                                                        <span
                                                            v-on:click="handlerModalTimeline(props.formattedRow['ID'])"
                                                            style="cursor: pointer;">
                                                            {{props.formattedRow[props.column.field]}}
                                                    ...
                                                    <span style="background-color: #9C640C;" class="status-handler"
                                                        v-else-if="props.formattedRow[props.column.field] === 'Shipment / Customs Process'">
                                                        <span
                                                            v-on:click="handlerModalTimeline(props.formattedRow['ID'])"
                                                            style="cursor: pointer;">
                                                            {{props.formattedRow[props.column.field]}}
                                                    ...
                                                    <span style="background-color: #17202A;" class="status-handler"
                                                        v-else-if="props.formattedRow[props.column.field] === 'Waiting Customer Supply'">
                                                        <span
                                                            v-on:click="handlerModalTimeline(props.formattedRow['ID'])"
                                                            style="cursor: pointer;">
                                                            {{props.formattedRow[props.column.field]}}
                                                    ...
                                                    <span style="background-color: #DC7633;" class="status-handler"
                                                        v-else-if="props.formattedRow[props.column.field] === 'Waiting Shipment from Vendor'">
                                                        <span
                                                            v-on:click="handlerModalTimeline(props.formattedRow['ID'])"
                                                            style="cursor: pointer;">
                                                            {{props.formattedRow[props.column.field]}}
                                                    ...
                                                    <span
                                                        v-else-if="props.formattedRow[props.column.field] === null || props.formattedRow[props.column.field] === ''">Undefined</span>
                                                    <span class="status-handler warning"
                                                        v-else>{{props.formattedRow[props.column.field]}}</span>
                                                </div>
                                            </span>
                                            ...
                                            <span v-else-if="props.column.field == 'MATERIAL_SUPPLY'">
                                                <select v-model="datatable.rows[props.index].MATERIAL_SUPPLY"
                                                    :disabled="!grant_access"
                                                    :id="'mrm-track-material-supply-' +props.index"
                                                    v-on:change="handlerUpdateData(props.formattedRow['ID'], 'MATERIAL_SUPPLY', 'mrm-track-material-supply-' +props.index)">
                                                    <option value=""></option>
                                            ...
                                            <span v-else-if="props.column.field == 'ADDITIONAL_STATUS'">
                                                <select v-model="datatable.rows[props.index].ADDITIONAL_STATUS"
                                                    :disabled="!grant_access"
                                                    :id="'mrm-track-additional-status-' +props.index" v-on:change="handlerUpdateData(
                                                props.formattedRow['ID'], 
                                                'ADDITIONAL_STATUS', 
                                                'mrm-track-additional-status-' +props.index)">
                                                    <option selected value=""></option>
                                                    <option v-for="stat in stats" :key="stat.ID" :value="stat.ID">
                                                        {{stat.STAT_NAME}}</option>
                                                </select>
                                            </span>
                                            <span v-else-if="props.column.field == 'REMARKS'">
                                                <input :disabled="!grant_access"
                                                    :value="props.formattedRow[props.column.field]"
                                                    :id="'mrm-track-remarks-' +props.index"
                                                    v-on:change="handlerUpdateData(props.formattedRow['ID'], 'REMARKS', 'mrm-track-remarks-' +props.index)"
                                                    type="text">
                                            </span>
                                            ...
                                            <span v-else-if="props.column.field == 'PART_LOCATION'">
                                                <input :disabled="!grant_access"
                                                    :value="props.formattedRow[props.column.field]"
                                                    :id="'mrm-track-part-location-' +props.index"
                                                    v-on:change="handlerUpdateData(props.formattedRow['ID'], 'PART_LOCATION', 'mrm-track-part-location-' +props.index)">
                                            </span>
                                            <span v-else-if="props.column.field == 'QTY_AVAILABLE'">
                                                <span v-if="props.formattedRow[props.column.field] === null">
                                                    <input :disabled="!grant_access" type="number" min="0"
                                                        :value="props.formattedRow[props.column.field]"
                                                        :id="'mrm-track-qty-available-' +props.index"
                                                        v-on:change="handlerUpdateData(props.formattedRow['ID'], 'QTY_AVAILABLE', 'mrm-track-qty-available-' +props.index)">
                                                </span>
                                                <span v-else>
                                                    <input :disabled="!grant_access" type="number" min="0"
                                                        :value="parseFloat(props.formattedRow[props.column.field]).toFixed(2)"
                                                        :id="'mrm-track-qty-available-' +props.index"
                                                        v-on:change="handlerUpdateData(props.formattedRow['ID'], 'QTY_AVAILABLE', 'mrm-track-qty-available-' +props.index)">
                                                </span>
                                            </span>
                                            ...
                                            <span v-else-if="props.column.field == 'UIC'">
                                                <select v-model="datatable.rows[props.index].UIC"
                                                    :disabled="!grant_access" :id="'mrm-track-uic-' +props.index"
                                                    v-on:change="handlerUpdateData(props.formattedRow['ID'], 'UIC', 'mrm-track-uic-' +props.index)">
                                                    <option value=""></option>
                                            ...
                                            <span v-else-if="props.column.field == 'PURCHASE_ORDER'">
                                                <input :disabled="!grant_access"
                                                    :value="props.formattedRow[props.column.field]"
                                                    :id="'mrm-track-purchase-order-' +props.index"
                                                    v-on:change="handlerUpdateData(props.formattedRow['ID'], 'PURCHASE_ORDER', 'mrm-track-purchase-order-' +props.index)">
                                            </span>
                                            <span v-else-if="props.column.field == 'DATEPO'">
                                                <input :disabled="!grant_access"
                                                    :value="props.formattedRow[props.column.field]"
                                                    :id="'mrm-track-date-po-' +props.index"
                                                    v-on:change="handlerUpdateData(props.formattedRow['ID'], 'DATEPO', 'mrm-track-date-po-' +props.index)"
                                                    type="date">
                                            </span>
                                            <span v-else-if="props.column.field == 'AWB_NUMBER'">
                                                <input :disabled="!grant_access"
                                                    :value="props.formattedRow[props.column.field]"
                                                    :id="'mrm-track-awb-number-' +props.index"
                                                    v-on:change="handlerUpdateData(props.formattedRow['ID'], 'AWB_NUMBER', 'mrm-track-awb-number-' +props.index)">
                                            </span>
                                            <span v-else-if="props.column.field == 'ETA'">
                                                <input :disabled="!grant_access"
                                                    :value="props.formattedRow[props.column.field]"
                                                    :id="'mrm-track-eta-' +props.index"
                                                    v-on:change="handlerUpdateData(props.formattedRow['ID'], 'ETA', 'mrm-track-eta-' +props.index)"
                                                    type="date">
                                            </span>
                                            <span v-else-if="props.column.field == 'SPIN'">
                                                <input :disabled="!grant_access"
                                                    :value="props.formattedRow[props.column.field]"
                                                    :id="'mrm-track-spin-' +props.index"
                                                    v-on:change="handlerUpdateData(props.formattedRow['ID'], 'SPIN', 'mrm-track-spin-' +props.index)">
                                            </span>
                                            <span v-else-if="props.column.field == 'DATEPRO'">
                                                <input :disabled="!grant_access"
                                                    :value="props.formattedRow[props.column.field]"
                                                    :id="'mrm-track-datepro-' +props.index"
                                                    v-on:change="handlerUpdateData(props.formattedRow['ID'], 'DATEPRO', 'mrm-track-datepro-' +props.index)"
                                                    type="date">
                                            </span>
                                            <span class="ctoggle" v-else-if="props.column.field == 'GADCREQ'">
                                                <span
                                                    v-if="props.formattedRow['MATFULSTAT']=='Available at GMF Central Store' || props.formattedRow['MATFULSTAT']=='Waiting for Distribution' || (props.formattedRow['QTYOWING'] !='0.0' && (props.formattedRow['QTYDEL'] !='0.0' || props.formattedRow['QTYINS'] !='0.0') && (props.formattedRow['QTYDEL'] !=null || props.formattedRow['QTYINS'] !=null) && props.formattedRow['GADCREQ']=='y')">
                                                    <div>
                                                        <input :disabled="!grant_access" type="checkbox"
                                                            class="switch unset" @change="changegadcreq(props.row)"
                                                            true-value="y" false-value="" v-model="props.row.GADCREQ">
                                                    </div>
                                                </span>
                                            </span>
                                            <span v-else-if="props.column.field == 'DN'">
                                                <input :disabled="!grant_access"
                                                    :value="props.formattedRow[props.column.field]"
                                                    :id="'mrm-track-dn-number-' +props.index"
                                                    v-on:change="handlerUpdateData(props.formattedRow['ID'], 'DN', 'mrm-track-dn-number-' +props.index)">
                                            </span>
                                            <span v-else-if="props.column.field == 'TO'">
                                                <input :disabled="!grant_access"
                                                    :value="props.formattedRow[props.column.field]"
                                                    :id="'mrm-track-to-number-' +props.index"
                                                    v-on:change="handlerUpdateData(props.formattedRow['ID'], 'TO', 'mrm-track-to-number-' +props.index)">
                                            </span>
                                            ...
                                            <span v-else-if="props.column.field == 'DATEPL'">
                                                <input :disabled="!grant_access"
                                                    :value="props.formattedRow[props.column.field]"
                                                    :id="'mrm-track-date-preload-' +props.index"
                                                    v-on:change="handlerUpdateData(props.formattedRow['ID'], 'DATEPL', 'mrm-track-date-preload-' +props.index)"
                                                    type="date">
                                            </span>
                                            <span v-else-if="props.column.field == 'RECEIVED_BY'">
                                                <input :disabled="!grant_access"
                                                    :value="props.formattedRow[props.column.field]"
                                                    :id="'mrm-track-received-by-' +props.index"
                                                    v-on:change="handlerUpdateData(props.formattedRow['ID'], 'RECEIVED_BY', 'mrm-track-received-by-' +props.index)">
                                            </span>
                                            <span v-else-if="props.column.field == 'DATEREC'">
                                                <input :disabled="!grant_access"
                                                    :value="props.formattedRow[props.column.field]"
                                                    :id="'mrm-track-date-received-' +props.index"
                                                    v-on:change="handlerUpdateData(props.formattedRow['ID'], 'DATEREC', 'mrm-track-date-received-' +props.index)"
                                                    type="date">
                                            </span>
                                            <span v-else-if="props.column.field == 'NETVAL'">
                                                ...
                                                <span v-else>
                                                    <input :disabled="!grant_access"
                                                        :value="props.formattedRow[props.column.field]==null ? null : parseFloat(props.formattedRow[props.column.field]).toFixed(2)"
                                                        :id="'mrm-track-netval-' +props.index"
                                                        v-on:change="handlerUpdateData(props.formattedRow['ID'], 'NETVAL', 'mrm-track-netval-' +props.index)"
                                                        type="number">
                                                </span>
                                            </span>
                                            <span v-else-if="props.column.field == 'CURR'">
                                                ...
                                                <span v-else>
                                                    <input :disabled="!grant_access"
                                                        :value="props.formattedRow[props.column.field]"
                                                        :id="'mrm-track-curr-' +props.index"
                                                        v-on:change="handlerUpdateData(props.formattedRow['ID'], 'CURR', 'mrm-track-curr-' +props.index)">
                                                </span>
                                            </span>
                                            <span v-else-if="props.column.field == 'VENDOR'">
                                                ...
                                                <span v-else>
                                                    <input :disabled="!grant_access"
                                                        :value="props.formattedRow[props.column.field]"
                                                        :id="'mrm-track-vendor-' +props.index"
                                                        v-on:change="handlerUpdateData(props.formattedRow['ID'], 'VENDOR', 'mrm-track-vendor-' +props.index)">
                                                </span>
                                            </span>
                                            <span v-else-if="props.column.field == 'PAYMENT_STATUS'">
                                                ...
                                                <span v-else>
                                                    <input :disabled="!grant_access"
                                                        :value="props.formattedRow[props.column.field]"
                                                        :id="'mrm-track-date-payment-' +props.index"
                                                        v-on:change="handlerUpdateData(props.formattedRow['ID'], 'PAYMENT_STATUS', 'mrm-track-date-payment-' +props.index)"
                                                        type="date">
                                                </span>
                                            </span>
                                            <span v-else-if="props.column.field == 'QTYDEL'">
                                                <span v-if="props.formattedRow[props.column.field] === null">
                                                    <input :disabled="!grant_access" type="number" min="0"
                                                        :value="props.formattedRow[props.column.field]"
                                                        :id="'mrm-track-qty-delivered-' +props.index"
                                                        v-on:change="handlerUpdateData(props.formattedRow['ID'], 'QTYDEL', 'mrm-track-qty-delivered-' +props.index)">
                                                </span>
                                                <span v-else>
                                                    <input :disabled="!grant_access" type="number" min="0"
                                                        :value="parseFloat(props.formattedRow[props.column.field]).toFixed(2)"
                                            ...
                                            <span v-else-if="props.column.field == 'QTYINS'">
                                                <span v-if="props.formattedRow[props.column.field] === null">
                                                    <input :disabled="!grant_access" type="number" min="0"
                                                        :value="props.formattedRow[props.column.field]"
                                                        :id="'mrm-track-qty-install-' +props.index"
                                                        v-on:change="handlerUpdateData(props.formattedRow['ID'], 'QTYINS', 'mrm-track-qty-install-' +props.index)">
                                                </span>
                                                <span v-else>
                                                    <input :disabled="!grant_access" type="number" min="0"
                                                        :value="parseFloat(props.formattedRow[props.column.field]).toFixed(2)"
                                            ...
                                            <span v-else-if="props.column.field == 'RWS'">
                                                <input :disabled="!grant_access"
                                                    :value="props.formattedRow[props.column.field]"
                                                    :id="'mrm-track-rws-' +props.index"
                                                    v-on:change="handlerUpdateData(props.formattedRow['ID'], 'RWS', 'mrm-track-rws-' +props.index)">
                                            </span>
                                            ...
                                            <span v-else-if="props.column.field == 'LGORT'">
                                                <div style="margin-top: 6px; text-align: left;">
                                                    <span v-for="(elem, index) in props.formattedRow['LGORT']"
                                                        :key="index">
                                            ...
                                            <span v-else-if="props.column.field == 'ARBPL'">
                                                <div style="margin-top: 6px; text-align: left;">
                                                    <span v-for="(elem, index) in props.formattedRow['ARBPL']"
                                                        :key="index">
                                                        <span class="slochandler" v-if="elem!==''">{{elem}}</span>
                                                    </span>
                                                </div>
                                            ...
                                            <span v-else-if="props.column.field == 'ACTION'">
                                                <span v-if="props.formattedRow['STORE_STATUS'] === 'addmrm'">
                                                    <div class="action tooltip-x"
                                                        ...
                                                        <i v-if="grant_access"
                                                            v-on:click="handlerDeleteItem(props.formattedRow['ID'])"
                                                            style="font-size: 10pt; font-weight: bold;"
                                                            class="material-icons danger">delete</i>
                                                    </div>
                                                </span>
                                            </span>
                                            <span v-else>
                                        ...
                                        <div slot="selected-row-actions">
                                            <button :disabled="!grant_access" v-on:click="bulkChangeVisibility('y')"
                                                class="button"><i class='material-icons'>visibility</i> Include
                                                {{ this.datatable.selectedRows.length }} Selected</button>
                                            <button :disabled="!grant_access" v-on:click="bulkChangeVisibility('n')"
                                                class="button"><i class='material-icons'>visibility_off</i> Exclude
                                                {{ this.datatable.selectedRows.length }} Selected</button>
                                        </div>
                                    </vue-good-table>
                        ...
                        <div class="modal-body" style="position: relative">
                            ...
                            <div class="is-row">
                                <div class="form-item is-col is-100">
                                    <input ref="file" id="file" style="all: unset" type="file"
                                        v-on:change="onChangeFileUpload()">
                                    <div class="is-desc">Required .xlsx file</div>
                                </div>
                                <div class="form-item is-col is-100">
                                    <button class="button is-secondary is-success"
                                        v-on:click="handlerExportMRMforupdate()">Download Template</button>
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer" style="">
                            <button class="button is-primary is-default cancel"
                                v-on:click="hideModal('modal-import-reservation')">Close</button>
                            <button v-on:click="handlerImport()" class="button is-success" type="submit"
                                id="btn-import-reservation"> Save </button>
                ...
                <div class="modal-box" id="modal-bulk-add" data-keyboard="false" data-backdrop="static">
                    <div class="modal sm">
                        ...
                        <div class="modal-body" style="position: relative">
                            ...
                            <div class="is-row">
                                <div class="form-item is-col is-100">
                                    <input ref="file_bulk_add" id="file_bulk_add" style="all: unset" type="file"
                                        v-on:change="onChangeBulkFileUpload()">
                                    <div class="is-desc">Required .xlsx file</div>
                                </div>
                                <div class="form-item is-col is-100">
                        ...
                        <div class="modal-footer" style="">
                            <button class="button is-primary is-default cancel"
                                v-on:click="hideModal('modal-bulk-add')">Close</button>
                            <button v-on:click="handlerBulkAdd()" class="button is-success" type="submit"
                                id="btn-bulk-add">
                                Save </button>
                        </div>
                    </div>
                ...
                <div class="modal-box" id="modal-layout" data-keyboard="false" data-backdrop="static">
                    <div class="modal sm">
                        ...
                        <div class="modal-body" style="position: relative; height:500px; overflow-y:auto;">
                            <draggable :list="datatable.fields" class="list-group" ghost-class="ghost"
                                ...
                                <transition-group type="transition" :name="!drag ? 'flip-list' : null">
                                    <div v-for="(element, index) in datatable.fields" :key="index + 0">
                                        <div class="list-group-item"
                                            v-if="element.label !== 'ID' && element.label  !== 'is_add' && element.label !== 'DATEATGAH4'">
                                            ...
                                            <div class="is-row" v-if="element.hidden==false" style="font-weight:bold;">
                                                ...
                                                <div class="is-col is-10">
                                                    <button class="button is-100 is-secondary is-success"
                                                        style="padding:0px !important;"
                                                        v-on:click="element.hidden = true">HIDE</button>
                                                </div>
                                            </div>
                                            <div class="is-row" v-else>
                                                ...
                                                <div class="is-col is-10">
                                                    <button class="button is-100 is-default"
                                                        v-on:click="element.hidden = false">SHOW</button>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="modal-footer" style="">
                            <button class="button is-primary is-default cancel"
                                v-on:click="hideModal('modal-layout')">Close</button>
                            <button v-on:click="handlerResetLayout()" class="button is-danger" type="button"
                                id="btn-reset-layout"> Reset Layout </button>
                            <button v-on:click="handlerSaveArrangedLayout()" class="button is-primary" type="button"
                                id="btn-save-layout"> Save Aranged Layout </button>
                        </div>
                        <!-- </form> -->
                    </div>
                </div>
                ...
                <div class="modal-box" id="modal-single-add" data-keyboard="false" data-backdrop="static">
                    <div class="modal lg">
                            ...
                            <div class="is-row" style="margin-top: -10px;">
                                ...
                                <div class="form-item is-col is-30">
                                    <select v-model="form.additional_status">
                                        <option value="">Option</option>
                                        <option v-for="stat in stats" :key="stat.ID" :value="stat.ID">{{stat.STAT_NAME}}
                                        </option>
                                    </select>
                        ...
                        <div class="modal-footer" style="">
                            <button class="button is-primary is-default cancel"
                                v-on:click="hideModal('modal-single-add')">Close</button>
                            <button v-on:click="handlerSaveSinglMDR()" class="button is-success" type="submit"
                                id="btn-single-add"> Save </button>
                    ...
                    <div class="modal sm">
                        ...
                        <div class="modal-body">
                            ...
                            <div
                                ...
                                <Timeline v-for="(timeline, index) in timelines" :key="index" :data="timeline"
                                    :index="index" />
                            </div>
                        </div>
                        <div class="modal-footer" style="">
                            <button class="button is-primary is-default cancel"
                                v-on:click="hideModal('modal-timeline')">Close</button>
                        </div>
                    </div>
                </div>
                <!-- /modal timeline -->
                ...
                <div class="modal-box" id="modal-detail-status" data-keyboard="false" data-backdrop="static">
                    <div class="modal sm">
                        ...
                        <div class="modal-body">
                            ...
                            <div
                                style="position: relative; height:80px; overflow-y:auto; margin-left: 10px; margin-right: 10px;">
                                <center><b>{{statusdetail}}</b></center>
                            </div>
                        </div>
                        <div class="modal-footer" style="">
                            <button class="button is-primary is-default cancel"
                                v-on:click="hideModal('modal-detail-status')">Close</button>
                        </div>
                    </div>
                </div>
                <!-- /modal detail status -->
                ...
                <div class="modal-box" id="modal-stockoverview" data-keyboard="false" data-backdrop="static">
                    <div class="modal" style="width:80%;">
                        ...
                        <div class="modal-header">
                            ...
                            only material with "<span style="color:gray;">Undefined</span>" status, "<span
                                style="color:#7B241C;">Available at GMF Central Store</span>" status and "<span
                                style="color:#E74C3C;">Waiting Purchase Order</span>" status are listed here
                        </div>
                        <div class="modal-body" style="position: relative">
                        ...
                        <div class="modal-footer" style="">
                            <button class="button is-primary is-default cancel"
                                v-on:click="hideStockOverview()">Close</button>
...
<script>
    ...
    export default {
        ...
        methods: {
            initData: function () {
                $(".vgt-fixed-header, .vgt-responsive").wrapAll("<div class='new' />").css("width", "unset").css(
                    "overflow-x", "unset");
            ...
            handlerSyncInventory: function () {
                swal({
                    ...
                    .then((value) => {
                        if (value) {
                            this.loading.isLoading = true;
                            axios.get('/api/production_control_hangar/sync_inventory/' + this.$route.params
                                    .pg_id)
                                .then(res => {
                                    if (res.data.success) {
                                        toastr.success(res.data.message);
