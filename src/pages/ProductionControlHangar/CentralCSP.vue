...
<template>
    <div>
        ...
        <div class="content-body" style="padding-top:40px;">
            <ul class="tab-menu">
                <li v-on:click="$router.push({name: 'pc_hangar.tracking.dashboard_summary', params: {pg_id: $route.params.pg_id}})" class="tab-link" data-tab="dashboard">Dashboard</li>
                <li v-on:click="$router.push({name: 'pc_hangar.tracking.jobcard', params: {pg_id: $route.params.pg_id}})" class="tab-link" data-tab="jobcard">Jobcard</li>
                <li v-on:click="$router.push({name: 'pc_hangar.tracking.mdr', params: {pg_id: $route.params.pg_id}})" class="tab-link" data-tab="mdr">MDR</li>
                <li v-on:click="$router.push({name: 'pc_hangar.tracking.mrm', params: {pg_id: $route.params.pg_id}})" class="tab-link" data-tab="mrm">MRM</li>
                <li class="tab-link" data-tab="prm">PRM</li>
                <li class="tab-link active" data-tab="csp">CSP</li>
                <li v-on:click="$router.push({name: 'pc_hangar.tracking.crm', params: {pg_id: $route.params.pg_id}})" class="tab-link" data-tab="csp">CRM</li>
            </ul>
                                    ...
                                    >
                                        ...
                                        <template slot="table-row" slot-scope="props">
                                            <span v-if="props.column.field == 'PART_NUMBER'">
                                                <input :disabled="!grant_access" style="min-width: 200px;" :value="props.formattedRow[props.column.field]" :id="'csp-track-part-number-' +props.index" v-on:change="handlerUpdateData(props.formattedRow['ID'], 'PART_NUMBER','csp-track-part-number-' +props.index)">
                                            </span>
                                            <span v-else-if="props.column.field == 'SERIAL_NUMBER'">
                                                <input :disabled="!grant_access" style="min-width: 200px;" :value="props.formattedRow[props.column.field]" :id="'csp-track-serial-number-' +props.index" v-on:change="handlerUpdateData(props.formattedRow['ID'], 'SERIAL_NUMBER','csp-track-serial-number-' +props.index)">
                                            </span>
                                            <span v-else-if="props.column.field == 'REMARKS'">
                                                <input :disabled="!grant_access" style="min-width: 300px;" :value="props.formattedRow[props.column.field]" :id="'csp-track-remark-' +props.index" v-on:change="handlerUpdateData(props.formattedRow['ID'], 'REMARKS','csp-track-remark-' +props.index)">
                                            </span>
                                            <span v-else-if="props.column.field == 'DESCRIPTION'">
                                                <input :disabled="!grant_access" style="min-width: 300px;" :value="props.formattedRow[props.column.field]" :id="'csp-track-description-' +props.index" v-on:change="handlerUpdateData(props.formattedRow['ID'], 'DESCRIPTION','csp-track-description-' +props.index)">
                                            </span>
                                            <span v-else-if="props.column.field == 'QTY'">
                                                <input :disabled="!grant_access" type="number" style="min-width: 50px;" :value="props.formattedRow[props.column.field]" :id="'csp-track-qty-' +props.index" v-on:change="handlerUpdateData(props.formattedRow['ID'], 'QTY','csp-track-qty-' +props.index)">
                                            </span>
                                            <span v-else-if="props.column.field == 'NO_AWB'">
                                                <input :disabled="!grant_access" style="min-width: 150px;" :value="props.formattedRow[props.column.field]" :id="'csp-track-awb-' +props.index" v-on:change="handlerUpdateData(props.formattedRow['ID'], 'NO_AWB','csp-track-awb-' +props.index)">
                                            </span>
                                            <span v-else-if="props.column.field == 'NO_INB'">
                                                <input :disabled="!grant_access" style="min-width: 130px;" :value="props.formattedRow[props.column.field]" :id="'csp-track-no-inb-' +props.index" v-on:change="handlerUpdateData(props.formattedRow['ID'], 'NO_INB','csp-track-no-inb-' +props.index)">
                                            </span>
                                            <span v-else-if="props.column.field == 'DATE_ISSUE'">
                                                <input :disabled="!grant_access" type="date" :value="props.formattedRow[props.column.field]" :id="'csp-track-date-issue-' +props.index" v-on:change="handlerUpdateData(props.formattedRow['ID'], 'DATE_ISSUE','csp-track-date-issue-' +props.index)">
                                            </span>
                                            <span v-else-if="props.column.field == 'NDSP'">
                                                <input :disabled="!grant_access" style="min-width: 130px;" :value="props.formattedRow[props.column.field]" :id="'csp-track-ndsp-' +props.index" v-on:change="handlerUpdateData(props.formattedRow['ID'], 'NDSP','csp-track-ndsp-' +props.index)">
                                            </span>
                                            <span v-else-if="props.column.field == 'DATEIN'">
                                                <input :disabled="!grant_access" type="date" :value="props.formattedRow[props.column.field]" :id="'csp-track-datein-' +props.index" v-on:change="handlerUpdateData(props.formattedRow['ID'], 'DATEIN','csp-track-datein-' +props.index)">
                                            </span>
                                            <span v-else-if="props.column.field == 'REF_NO_ORDER'">
                                                <input :disabled="!grant_access" style="min-width: 130px;" :value="props.formattedRow[props.column.field]" :id="'csp-track-ref-no-' +props.index" v-on:change="handlerUpdateData(props.formattedRow['ID'], 'REF_NO_ORDER','csp-track-ref-no-' +props.index)">
                                            </span>

                                            <span v-else-if="props.column.field == 'STATUS'">
                                                <select :disabled="!grant_access" :class="handlerClassStatus(props.formattedRow[props.column.field])" :id="'csp-track-status-' +props.index" 
                                                ...
                                                >
                                                    ...
                                                    <option :selected="props.formattedRow[props.column.field] === stat.STAT_NAME" v-for="stat in stats" :key="stat.ID" :value="stat.STAT_NAME">{{stat.STAT_NAME}}</option>
                                                </select>
                                            </span>
                                            <span v-else>
...
import FieldCSP from './Project/datatable/FieldCSP';
...
export default {
    ...
    methods: {
        ...
        initData:  function() {
            ...
            axios.post('/api/production_control_hangar/get_tcsp', this.datatable.serverParams)
            .then(res => {
        ...
        handleDatatableChange: function(params) {
            ...
            return new Promise((resolve, reject) => {
                ...
                axios.post('/api/production_control_hangar/get_tcsp', params)
                .then(res => {
                    this.datatable.rows = res.data.data
                    this.datatable.totalRows = res.data.total
                    this.loading.isLoading = false;
        ...
        handlerClassStatus: function(data) {
            ...
            else class_name = "status-handler danger";
        ...
        handlerExport: function(data, name) {
            return new Promise((resolve, reject) => {
                ...
                XLSX.writeFile(wb, `csp_tracking_${this.$route.params.pg_id}.xlsx`)
        ...
        permissionHandler: function() {
            ...
            if(this.$can('pc_hangar_tracking_system_edit')) {
