            ...
            <div class="is-col is-65">
                <div class="timeline-content">
                    ...
                    <span v-for="dbcolumn in dbcolumns" :key="dbcolumn.field" :value="dbcolumn.field">
                        <span v-if="dbcolumn.field==$props.data.column_name">
                            <span v-if="dbcolumn.field=='TRACK_STATUS'">Order Status</span>
                            <span v-else>{{dbcolumn.label}}</span>
                        </span>
                    </span>
                    </div>
                    <div class="body">
...
export default {
    ...
    data: () => ({
        jccolumns: FieldJobcard,
        mdrcolumns: FieldMDR,
        dbcolumns: [],
    }),
    mounted() {
        this.dbcolumns = this.mdrcolumns.concat(this.jccolumns).filter(function(o) {  
