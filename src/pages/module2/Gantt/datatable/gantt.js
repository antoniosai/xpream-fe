    ...
    return function (t) {
        ...
        l.prototype = {
            ...
            setSize: function (t, e) {
                ...
                i !== t && (void 0 !== i ? (s.grid_width = i, this.$config.width = i - 1) : isNaN(r) || (this._setColumnsWidth(r), s.grid_width = r, this.$config.width = r - 1));
        ...
        t.exports = function (t) {
            return {
                getWorkHoursArguments: function () {
                    ...
                    if (e = r.isDate(e) ? {
                            date: e
                        } : n.mixin({}, e), !r.isValidDate(e.date)) throw t.assert(!1, "Invalid date argument for getWorkHours method"), new Error("Invalid date argument for getWorkHours method");
                    return e
                },
                ...
                isWorkTimeArguments: function () {
                    ...
                    if ((e = i.date ? new a(i.date, i.unit, i.task, null, i.calendar) : new a(arguments[0], arguments[1], arguments[2], null, arguments[3])).unit = e.unit || t.config.duration_unit, !r.isValidDate(e.date)) throw t.assert(!1, "Invalid date argument for isWorkTime method"), new Error("Invalid date argument for isWorkTime method");
                    return e
                },
                getClosestWorkTimeArguments: function (e) {
                    var i, n = arguments[0];
                    if (n instanceof o) return n;
                    if (i = r.isDate(n) ? new o(n) : new o(n.date, n.dir, n.unit, n.task, null, n.calendar), n.id && (i.task = n), i.dir = n.dir || "any", i.unit = n.unit || t.config.duration_unit, !r.isValidDate(i.date)) throw t.assert(!1, "Invalid date argument for getClosestWorkTime method"), new Error("Invalid date argument for getClosestWorkTime method");
                    return i
                },
                _getStartEndConfig: function (e) {
                    var i, n = l;
                    if (e instanceof n) return e;
                    if (r.isDate(e) ? i = new n(arguments[0], arguments[1], arguments[2], arguments[3]) : (i = new n(e.start_date, e.end_date, e.task), e.id && (i.task = e)), i.unit = i.unit || t.config.duration_unit, i.step = i.step || t.config.duration_step, i.start_date = i.start_date || i.start || i.date, !r.isValidDate(i.start_date)) throw t.assert(!1, "Invalid start_date argument for getDuration method"), new Error("Invalid start_date argument for getDuration method");
                    if (!r.isValidDate(i.end_date)) throw t.assert(!1, "Invalid end_date argument for getDuration method"), new Error("Invalid end_date argument for getDuration method");
                    return i
                },
            ...
            t.assert = i(46)(t), t.init = function (t, e, i) {
                ...
                this.callEvent("onBeforeGanttReady", []), this._eventRemoveAll(), this.$mouseEvents.reset(), this.resetLightbox(), this._update_flags(), this.$services.getService("templateLoader").initTemplates(this), this._clearTaskLayers(), this._clearLinkLayers(), this.$layout && (this.$layout.destructor(), this.$ui.reset()), this.$root = n.toNode(i), this.$root && (this.$root.innerHTML = ""), this.$root.gantt = this, e(this), this.config.layout.id = "main", this.$layout = this.$ui.createView("layout", i, this.config.layout), this.$layout.attachEvent("onBeforeResize", function () {
                    ...
                    function (t) {
                        ...
                        e.className = "gantt_container_resize_watcher", e.tabIndex = -1, t.config.wai_aria_attributes && (e.setAttribute("role", "none"), e.setAttribute("aria-hidden", !0));
                        t.$root.appendChild(e), e.contentWindow ? a(t, e.contentWindow) : (t.$root.removeChild(e), a(t, window))
        ...
        t.exports = function (t) {
            ...
            for (var o in t._waiAria = {
                    ...
                    _taskCommonAttr: function (e, i) {
                        e.start_date && e.end_date && (i.setAttribute("aria-label", n(t.templates.tooltip_text(e.start_date, e.end_date, e))), e.$dataprocessor_class && i.setAttribute("aria-busy", !0), i.setAttribute("aria-selected", t.isSelectedTask(e.id) ? "true" : "false"))
                    },
                    ...
                    gridCellAttrString: function (e, i, n) {
                        ...
                        return e.editor && !t.isReadonly(n) || (r["aria-readonly"] = !0), this.getAttributeString(r)
                    },
        ...
        var n = function () {
            ...
            return t.create = function (e, i) {
                return void 0 === e && (e = null), new t(i)
            }, t
        }();
        e.default = n
    }, function (t, e, i) {
        ...
        var r = function (t) {
            function e(e, i) {
                ...
                return n.format = function (t) {
                    ...
                    for (e in n._config.labels)
                        if (n._gantt.config.links[e].toLowerCase() === t.toLowerCase()) break;
                    return e
                    ...
                    var e = t.replace(/[^a-zA-Z]/gi, ""),
                        i = "finish_to_start";
                    for (var r in n._config.labels) n._config.labels[r].toLowerCase() === e.toLowerCase() && (i = r);
                    return i
                }, n._parseLag = function (t) {
                    return t ? n._config.durationFormatter.parse(t) : 0
                }, n._config = n._defaultSettings(e), n._linkReg = /^[0-9\.]+[a-zA-Z]*/, n
            }
            return n(e, t), e.prototype._defaultSettings = function (t) {
                ...
                return void 0 === t && (t = null), new e(t, i)
            }, e
        }(i(91).default);
        e.default = r
    }, function (t, e, i) {
        ...
        t.exports = function (t) {
            t.ext.formatters = {
                durationFormatter: function (e) {
                    return e || (e = {}), e.store || (e.store = t.config.duration_unit), e.enter || (e.enter = t.config.duration_unit), n.create(e, t)
                },
                    ...
                    return {
                        render: function (i, n, r) {
                            ...
                            for (var f = 0; f < c.length; f++) {
                                ...
                                if (!u || d(g, s, r)) {
                                    var p = e(i, _, o, a, n);
                                    p && (h.push(p), t[i.id][g] = p)
                                }
                            }
                            var v = null;
                            if (h.length)
                                for (v = document.createElement("div"), f = 0; f < h.length; f++) v.appendChild(h[f]);
                            return v
                        },
        ...
        var n = i(1),
            r = function (t, e) {
                ...
                _.attachEvent("onBeforeDragStart", e.bind(function (i, r) {
                    ...
                    } else this._dir_end = n.getRelativeEventPosition(s, t.$task_data), e.env.isEdge && (this._dir_end.y += window.scrollY);
                    var S = !(h == u && d == m && f == b);
                        ...
                        return t = function (t, e) {
                            ...
                            return {
                                ...
                                _resize: function (i, n, r) {
                                    ...
                                    r.left ? (i.start_date = e.dateFromPos(o.start + n), i.start_date || (i.start_date = new Date(e.getState().min_date))) : (i.end_date = e.dateFromPos(o.end + n), i.end_date || (i.end_date = new Date(e.getState().max_date)));
                                    var s = this._calculateMinDuration(a.min_duration, a.duration_unit);
                                    i.end_date - i.start_date < a.min_duration && (r.left ? i.start_date = e.calculateEndDate(i.end_date, -s, a.duration_unit, i) : i.end_date = e.calculateEndDate(i.start_date, s, a.duration_unit, i)), e._init_task_timing(i)
                                },
            ...
            function l(l, c, u) {
                ...
                return u && u.setAttribute(e.config().layer_attribute, !0), o[l] = {
                    ...
                    append: function (t, e, i) {
                        this.rendered && (e ? (this.rendered[t.id] && this.rendered[t.id].parentNode ? this.replace_item(t.id, e) : i.appendChild(e), this.rendered[t.id] = e) : this.rendered[t.id] && this.remove_item(t.id))
                    },
        ...
        i(21), t.exports = function () {
            var t = new function () {
                this.constants = i(174), this.version = "6.3.4", this.license = "site", this.templates = {}, this.ext = {}, this.keys = {
