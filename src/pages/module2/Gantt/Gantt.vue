<style scoped>
    ...
    ::v-deep .handover-job-exists {
        background: #0065ff !important;
    }

    ::v-deep .handover-job-unexists {
...
export default {
    ...
    methods: {
        initGantt: function () {
            ...
            // const jobHandoverPerDay = this.$props.jobHandoverPerDay.data;
                        ...
                        for(let j = 0; j < 2; j++) {
                            ...
                            switch(resource.key) {
                                    ...
                                    case "menu-10":
                                        ...
                                        icon = "dvr";
                                        type = "warning";
                                        // if(jobHandoverPerDay.filter(a => a.plan_date == plan_date && a.type == 'SYSTEM' && a.shift == j+1).length) {
                                        //     color = 'handover-job-exists'
                                        // } else {
                                        //     color = 'handover-job-unexists'
                                        // }
                            ...
                            if(type && icon) {
                                ...
                                div_e.innerHTML = `<i onclick="${func_name}('${getPg}', '${convertDate(day.start_date)}', '${shift}', '${index}', '${type_edit}', '${status_edit}')" class='material-icons ${status_edit} ${type} ${color}'>${icon}</i>`;
                            }
                            td.append(div_e);
                            tr.append(td);
                        }
