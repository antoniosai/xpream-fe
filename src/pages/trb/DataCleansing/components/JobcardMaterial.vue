...
export default {
    ...
    methods: {
        initData: function() {
            ...
            axios.get(`/api/data_cleansing/validation/job_material/get/GA01/${this.$props.draft_id}`)
            .then(res => {
        ...
        handlerUpdateData: function(id, column, elem) {
            ...
            axios.post('/api/data_cleansing/validation/job_material/update', {
                id: id,
                column: column,
                data: elm,
        ...
        handlerDeleteItem: function(id) {
            ...
            .then((value) => {
                if (value) {
                    this.loading.isLoading = true;
                    axios.get('/api/data_cleansing/validation/job_material/delete/' + id)
                    .then(res => {
                        if(res.data.success) {
                            toastr.success(res.data.message);
                            this.initData();
