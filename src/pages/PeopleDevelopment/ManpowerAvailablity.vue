    ...
    <div>
        ...
        <div class="card" style="margin-bottom: 15px; top: 0; position: sticky; z-index: 2; width: 100%;">
            <div class="option-box">
                <div class="option-item">
                    ...
                    <select id="location" v-model="filter.location" ref="location">
                ...
                <div class="option-item">
                    ...
                    <select @change="handlerFilter()" v-model="filter.line">
                ...
                <div class="option-item">
                    ...
                    <select v-on:change="handlerFilter()" v-model="filter.perPage" name="per-page" id="per-page">
                        <option :value="paginate.total_page">All</option>
                ...
                <div class="option-item">
                    <button class="button is-primary" @click="openModal('userguide')"> User Guide </button>
                </div>
            </div>
        </div>

        <div class="modal-box" id="userguide">
            <div class="modal lg">
                <span class="close" v-on:click="hideModal('userguide')"></span>
                ...
                <div class="modal-body" style="position: relative">
                    ...
                    <div class="is-row">
                        <div class="is-col is-100">
                            <div class="card">
                                <video v-if="video_isopen" height="100%" poster="/uploads/mpad_poster.jpg" controls>
                                    <source src="/uploads/mpad_guide.mp4" type="video/mp4">
                ...
                <div class="modal-footer" style="">
                    <button class="button is-primary is-default" v-on:click="hideModal('userguide')">Close</button>
                </div>
        ...
        <div v-if="!loading.isLoading" class="is-row">
            <div style="" class="is-col is-100 ms-container">
                ...
                <div class="is-row">
                    <div class="" v-for="(a, idx) of manpowerAvailablities" :key="idx">
                        <div class="ms-card">
                                                ...
                                                <div :id="'collapseOneStatus'+idx" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOneStatus">
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="task-info dark" style="background: #ff685a; color: rgb(255, 255, 255);">
                                                            <p>Ready to Work</p>
                                                            <span class="ms-badge" style="background: #92231b;color:#fff;border-color:#fff;">{{ a.on_job_status.undefined }}</span>
                                                        </div>
                        ...
                        <div>
                            <div style="display:flex;justify-content: space-between;">
                                <div  style="display:flex;flex-direction:column">
                                    <h3>Detail Manpower {{ a.description }} </h3>
                                    <span style="font-size:12px">Attendance Last Sync at : {{a.syncAt}}</span>
                                </div>
                                    ...
                                    <div class="legend">
                                        <div>
                                         ...
                                         <div>
                                            ...
                                            <span>Ready to Next Job</span>
                                        </div>
                                        <div>
                                            <span class="t niy" style="background: #92231b;"></span>
                                        ...
                                        <div>
                                         ...
                                         <div>
                                            <span class="t a" style="background:yellow;border: solid black 1px;"></span>
                                            <span>Late</span>
                                        </div>
                                         <div>
                                            <span class="t a" style="background:white;border: solid black 1px;"></span>
                                            <span>License valid</span>
                                        </div>
                                         <div>
                                            <span class="t a" style="background:red;border: solid black 1px;"></span>
                            ...
                            <div style="display: flex; align-items: center;">
                                <div class="form-group">
                                    ...
                                    <div class="select-dropdown">
                                        <select @click="filterUnit($event.target, idx)">
                                            <option value="">All</option>   
                                            <option
                                            v-for="(unit, i) of JSON.parse(a.production_unit)"
                                            :key="i"
                                            :value="unit"
                                            >
                                            {{ unit}}
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="c2" :name="'next_shift_'+idx" type="checkbox" checked @click="switchNextShift($event.target, idx)">
                                </div>
                            </div>
...
<script>
    ...
    export default {
        ...
        mounted() {
            this.initHangar();
            this.filter.location = '3'
        },

        methods: {

            switchNextShift(elm, idx) {
                const { checked } = elm;
                this.manpowerAvailablities[idx]['next_shift_switch_on_off'] = checked;
            },

            filterUnit(elm, idx) {
                const {selectedIndex, value} = elm;
                console.log(selectedIndex, value);
                const where =  {'is': false, 'unit': 'All'};

                if(value !== '') {
                    this.manpowerAvailablities[idx]['filter_unit'] = {...where, 'is':true, 'unit': value};
                } else {
                    this.manpowerAvailablities[idx]['filter_unit'] = where;
                }
            ...
            initData: function() {
                return new Promise(resolve => {
                    ...
                    this.filter.page = 1;
                    this.filter.perPage = this.filter.location === '' ? null : this.filter.perPage;
                    this.manpowerAvailablities = [];
                    axios
                        .post(
                        ...
                        .then(res => {
                            ...
                            if(res.data.data.length) {
                                for(const [i,v] of res.data.data.entries()) {
                                    ...
                                    this.$set(this.manpowerAvailablities[i], 'next_shift_switch_on_off', true); 
                                    this.$set(this.manpowerAvailablities[i], 'filter_unit', {'is': false, 'unit': 'All'});                
                            ...
                            this.filter.perPage = (!this.filter.perPage && this.filter.location != '') ? res.data.total : (!this.filter.perPage && this.filter.location == '') ?  res.data.total : this.filter.perPage;
            ...
            validateDateRange: function(date) {
                const ttl = moment().valueOf() - moment(date).valueOf() 
                const oneDayInMilis = 86400000;
                if(ttl >= oneDayInMilis) {
                    return true
                }
                return false;
            },
            ...
            setColumnDetailManpower: function(idx,rows, vm) {
                ...
                for (const [i,v] of rows) {
                    ...
                    vm.$set(vm.manpowerAvailablities[idx]['user'][i], "planned_end_time");
                    ...
                    vm.$set(vm.manpowerAvailablities[idx]['user'][i], "is_warning");
                    vm.$set(vm.manpowerAvailablities[idx]['user'][i], "is_late");
                    vm.$set(vm.manpowerAvailablities[idx]['user'][i], "clockin");
                    vm.$set(vm.manpowerAvailablities[idx]['user'][i], "planstart");
                }
           ...
           apolloManpowerAvailablities: function(row, idx, vm) {
                ...
                observer.subscribe({
                    next({
                        ...
                        if(vm.manpowerAvailablities.length) {
                            ...
                            if (personalStatus && personalStatus.length) {
                                ...
                                const personalStatusRejected = {
                                    Absence: [],
                                    NextShift: [],
                                    Off: []
                                }

                                for(const [ii, a] of personalStatus.entries()) {


                                    /* -------------------------------------------------------------------------- */
                                    /*                     Filter Personal Status (Available)                     */
                                    /* -------------------------------------------------------------------------- */


                                    if(row.attendance.Available.length) {
                                        for(const [i,b] of row.attendance.Available.entries()) {
                                            if(a.hasOwnProperty('personal_number')) {
                                                if(b.personnel_number == a.personal_number) {
                                                    if(vm.validateDateRange(a.update_at)) {
                                                        a.on_job_status = null;
                                                    }
                                                } 
                                   ...
                                   /* -------------------------------------------------------------------------- */
                                   /*             Filter Personal Status (Absence | Next Shift | Off)            */
                                   /* -------------------------------------------------------------------------- */
                                    ...
                                    if(row.attendance.Absence.length) {
                                        for(const [i,b] of row.attendance.Absence.entries()) {
                                            ...
                                            if(a.username == b.personnel_number) {
                                                personalStatusRejected.Absence.push(b)
                                            }
                                    ...
                                    if(row.attendance.NextShift.length) {
                                        for(const [i,b] of row.attendance.NextShift.entries()) {
                                            ...
                                            if(a.username == b.personnel_number) {
                                                personalStatusRejected.NextShift.push(b)
                                            }
                                    ...
                                    if(row.attendance.Off.length) {
                                        for(const [i,b] of row.attendance.Off.entries()) {

                                            if(a.username == b.personnel_number) {
                                                personalStatusRejected.Off.push(b)
                                            }
                                ...
                                personalStatusRejected.Absence = [...new Set(personalStatusRejected.Absence)];
                                personalStatusRejected.NextShift = [...new Set(personalStatusRejected.NextShift)];
                                personalStatusRejected.Off = [...new Set(personalStatusRejected.Off)];


                                for(const [i, a] of personalStatus.entries()) {
                                    ...
                                    if(row.attendance.Available.length) {
                                        for(const [ii,b] of row.attendance.Available.entries()) {
                                            if(a.hasOwnProperty('personal_number')) {
                                                if(b.personnel_number == a.personal_number) {
                                                    if(vm.validateDateRange(a.update_at)) {
                                                        a.on_job_status = null;
                                   ...
                                   /* -------------------------------------------------------------------------- */
                                    ...
                                    if(personalStatusRejected.Absence.length) {
                                        for(const b of personalStatusRejected.Absence) {
                                            if(a.hasOwnProperty('personal_number')) {
                                                if(b.personnel_number == a.personal_number) {
                                                    a.on_job_status = null;
                                                }
                                    ...
                                    if(personalStatusRejected.NextShift.length) {
                                        for(const b of personalStatusRejected.NextShift) {
                                            if(a.hasOwnProperty('personal_number')) {
                                                if(b.personnel_number == a.personal_number) {
                                                    a.on_job_status = null;
                                                }
                                    ...
                                    if(personalStatusRejected.Off.length) {
                                        for(const b of personalStatusRejected.Off) {
                                            if(a.hasOwnProperty('personal_number')) {
                                                if(b.personnel_number == a.personal_number) {
                                                    a.on_job_status = null;
                                                }
                                ...
                                let z = [];
                                const on_job_status = personalStatus.filter(i => i.on_job_status != null).map(i => i.on_job_status);
                                ...
                                console.log(row.attendance.Available.length, on_job_status.length, row.description)
                                for (const a in row.on_job_status) row.on_job_status['undefined'] = (row.attendance.Available.length - on_job_status.length) ? (row.attendance.Available.length - on_job_status.length) : '-'
                                ...
                                for(const a of personalStatus) {
                                    ...
                                    if(b.username == a.personal_number) {
                                        vm.$set(vm.manpowerAvailablities[idx]['user'][i], "planned_end_time", a.planned_end_time);
                                        ...
                                        vm.$set(vm.manpowerAvailablities[idx]['user'][i], "reason", a.personal_status_stop_reason);
                                        vm.$set(vm.manpowerAvailablities[idx]['user'][i], "is_warning", false);
                                        vm.$set(vm.manpowerAvailablities[idx]['user'][i], "is_late", false);
                                        vm.$set(vm.manpowerAvailablities[idx]['user'][i], "clockin", null);
                                        vm.$set(vm.manpowerAvailablities[idx]['user'][i], "planstart", null);

                                            

                                            if(a.on_job_status === 'break') {

                                                if(a.personal_status_stop_reason && a.personal_status_stop_reason.std_duration) {

                                                    const duration = ((a.personal_status_stop_reason.std_duration * 60) * 1000)
                                                    const updateAt = moment(a.update_at).format('YYYY-MM-DD HH:mm:ss')

                                                    /* -------------------------------------------------------------------------- */
                                                    /*                              without Interval                              */
                                                    /* -------------------------------------------------------------------------- */

                                                    let ttl = moment().valueOf() - moment(updateAt).valueOf();

                                                    if(ttl >= duration) {
                                                        vm.$set(vm.manpowerAvailablities[idx]['user'][i], "is_warning", true);
                                                    }
                                                    ...
                                                    intervalRef[i] = setInterval(function(){
                                                        
                                                        let ttl = moment().valueOf() - moment(updateAt).valueOf()
                                                        // ll(intervalRef[i],'belom abis');
                                                        if(ttl >= duration) {
                                                            vm.$set(vm.manpowerAvailablities[idx]['user'][i], "is_warning", true);
                                                            // ll(intervalRef[i],'abis');
                                            ...
                                            if(a.on_job_status === 'finish') {

                                                    const duration = ((7 * 60) * 1000) // seven minutes
                                                    const updateAt = moment(a.update_at).format('YYYY-MM-DD HH:mm:ss')
            ...
            openModal: function(modal_name) {
                if (modal_name === 'userguide') {
                    this.video_isopen = true;
                }               
                $("#" + modal_name).show();
            },
...
<style>
    ...
    /*.ms-container .is-row > div:nth-child(5n+0) {
        margin-left: unset;
    }
    */

    .ms-container .is-row > div {margin-right: 20px;}

    /*.ms-container .is-row > div:first-child {
        margin: unset;
    }*/

    /*.ms-container .is-row > div:nth-child(4n+0) {
        border: 1px solid red;
        margin-right: unset;
    }*/


    .ms-container .is-row > div {
        width: 277px;
    }
