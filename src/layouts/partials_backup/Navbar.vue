...
export default {
    methods: {
        logout: function () {
            swal({
                title: "Anda Akan Keluar Aplikasi",
                text: "Logout perlu dilakukan apabila sudah tidak lagi menggukanan aplikasi. Hal ini bertujuan mencegah hal-hal yang tidak diinginkan",
                icon: "warning",
                buttons: true,
                dangerMode: true,
            })
